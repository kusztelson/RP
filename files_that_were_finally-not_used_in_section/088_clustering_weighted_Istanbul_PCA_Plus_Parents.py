...
file_prefix = "Stanbul_WEIGHTED_PARENTS_V2"
...
# --- FLIP PCA SIGN ---
# Flip PC1 (if left-to-right orientation is reversed)
X_pca_data[:, 0] = X_pca_data[:, 0] * -1
loadings_df['PC1'] = loadings_df['PC1'] * -1
...
plt.title(f"Deconstructing PCA 1: Feature Contributions (Istanbul)")
plt.xlabel("Feature")
...
plt.title(f"Deconstructing PCA 2: Feature Contributions (Istanbul)")
plt.xlabel("Feature")
